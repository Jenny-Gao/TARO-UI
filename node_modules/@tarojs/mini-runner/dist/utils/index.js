...
function buildUsingComponents(filePath, sourceDir, pathAlias, components, isBuildPlugin, isComponent) {
    ...
    for (const component of components) {
        ...
        if (fs.existsSync(componentPath)) {
            if (helper_1.NODE_MODULES_REG.test(componentPath) && !helper_1.NODE_MODULES_REG.test(filePath)) {
                ...
                componentPath = componentPath.replace(helper_1.NODE_MODULES_REG, path.join(sourceDir, npmDir));
            }
